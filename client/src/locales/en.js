export default {
  ...
  srp: {
    ...
    loggedInAccounts: 'Logged in characters',
    addAccount: 'Add Account',
    accountAdded: 'Character added: {name}',
    accountRemoved: 'Character removed: {name}',
    confirmRemoveAccount: 'Confirm Remove Account',
    confirmRemoveAccountDesc: 'Are you sure you want to remove {name}?',
    accountsTotal: 'accounts',
    allAccountsRequests: 'All Accounts',
    logoutAll: 'Logout All Accounts',
    loggedOut: 'Logged out successfully',
    loginSuccess: 'Login successful!',
    loginFailed: 'Login failed',
    notCorpMember: 'Not a corporation member',
    verifying: 'Verifying identity...',
    verifyingDesc: 'Please wait, communicating with EVE Online server',
    lossesRefreshed: 'Loss records refreshed',
    viewOnZkill: 'View on zKillboard',
    apply: 'Apply',
    character: 'Character',
    killTime: 'Kill Time',
    noRequests: 'No requests yet',
    lastUpdate: 'Last update',
    refreshLosses: 'Refresh losses',
    loadMore: 'Load more',
    remaining: 'remaining',
